        ...
        <form ref={formRef} action={handleSubmit} className="space-y-3">
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="space-y-1.5">
              ...
              <Input id="weight-date" name="date" type="date" defaultValue={editEntry?.date ?? today} required className="h-11" />
            </div>
            <div className="space-y-1.5">
          ...
          {(showMore || editEntry) ? (
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input id="weight-bf" name="bodyFatPercent" type="number" inputMode="decimal" step="0.1" min="1" max="70" defaultValue={editEntry?.bodyFatPercent ?? ""} placeholder="Optional" className="h-11" />
              </div>
              <div className="space-y-1.5">
