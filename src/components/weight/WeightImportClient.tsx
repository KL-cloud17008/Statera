    ...
    <div className="page-shell">
      ...
      {state.step === "idle" && (
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-[--radius-surface] border border-dashed border-border bg-muted/30 p-10 text-center">
      ...
      {state.step === "preview" && (
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="max-h-80 overflow-y-auto rounded-[--radius-card] border border-border">
        ...
        <Card>
          <CardContent className="space-y-4 py-12 text-center">
            ...
            {state.errors.length > 0 ? (
              <div className="mx-auto max-w-lg rounded-[--radius-card] border border-border bg-muted/30 p-4 text-left">
