    ...
    <div className="page-shell">
      ...
      >
        <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
          <span className="rounded-full bg-muted/60 px-3 py-1.5">Goal {settings.stepGoal.toLocaleString()} steps</span>
          <span className="rounded-full bg-muted/60 px-3 py-1.5">{formatDistance(stats.todaySteps, settings.distanceUnit)}</span>
        </div>
      </SectionHeader>

      <section className="grid gap-4 xl:grid-cols-2">
        <div className="surface-elevated flex flex-col items-center justify-center rounded-[--radius-panel] px-6 py-8">
