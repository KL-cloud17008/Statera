    ...
    <div className="page-shell">
        ...
        <CardContent>
          <form action={handleProfileSave} className="grid gap-4 md:grid-cols-2">
            <Field label="Height (inches)" htmlFor="heightInches">
              <Input id="heightInches" name="heightInches" type="number" min="36" max="96" defaultValue={profile.heightInches ?? ""} className="h-11" />
            </Field>
            <Field label="Timezone" htmlFor="timezone">
              <Input id="timezone" name="timezone" type="text" defaultValue={profile.timezone} className="h-11" />
            </Field>
            <Field label="Start Weight (lbs)" htmlFor="startWeight">
              <Input id="startWeight" name="startWeight" type="number" step="0.1" min="50" max="999" defaultValue={profile.startWeight ?? ""} className="h-11" />
            </Field>
            <Field label="Goal Weight (lbs)" htmlFor="goalWeight">
              <Input id="goalWeight" name="goalWeight" type="number" step="0.1" min="50" max="999" defaultValue={profile.goalWeight ?? ""} className="h-11" />
            </Field>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Field label="Weight Unit" htmlFor="weightUnit">
                ...
                >
                  <SelectTrigger id="weightUnit" className="h-11 w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <Field label="Distance Unit" htmlFor="distanceUnit">
                ...
                >
                  <SelectTrigger id="distanceUnit" className="h-11 w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-[--radius-card] border border-border bg-muted/30 p-4 text-sm text-muted-foreground">
