    ...
    <header className="sticky top-0 z-40 px-3 pb-2 pt-[max(env(safe-area-inset-top),0.75rem)] md:hidden">
      <div className="chrome-surface flex items-end justify-between gap-4 rounded-[var(--radius-panel)] border px-4 py-3">
        <div className="flex items-center gap-3">
          <span className="flex size-9 items-center justify-center rounded-full border border-[var(--hairline)] bg-[var(--veil-1)] text-[var(--cream)]">
        ...
        <div className="hidden min-[440px]:block">
          <div className="mt-2 flex items-center gap-2 rounded-full border border-[var(--hairline)] bg-[var(--veil-1)] px-3 py-1.5 font-mono text-[0.65rem] font-medium uppercase tracking-[0.12em] text-[var(--cream-2)]">
