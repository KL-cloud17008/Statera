...
export const DEFAULT_WORKOUT_PLAN: DefaultWorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        exerciseName: "B1 Machine Hip Thrust",
        sets: 3,
        reps: "8-12",
        tempo: "2-1-2",
        restSeconds: 120,
        targetRPE: "6-7",
        cues: `${PLAN_CUE_PREFIX}Set the pad so the hips drive cleanly, pause at the top, and avoid turning the rep into a low-back arch.`,
        supersetGroup: "B",
        exerciseType: "WORKING",
      },
      {
        exerciseName: "B2 Machine Abdominal Crunch",
        sets: 3,
        reps: "10-15",
        tempo: "2-1-2",
        restSeconds: 120,
        targetRPE: "6-7",
        cues: `${PLAN_CUE_PREFIX}Brace first, curl the ribs toward the pelvis without yanking the handles, and rest after B2.`,
        supersetGroup: "B",
        exerciseType: "WORKING",
      },
      {
