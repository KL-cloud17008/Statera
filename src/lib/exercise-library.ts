...
export const DEFAULT_EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { id: "high-to-low-cable-fly", name: "High-to-Low Cable Fly", muscleGroup: "Chest", defaultSets: 3, defaultReps: "12-15", defaultRestSeconds: 120, source: "builtin" },
  ...
  { id: "machine-row", name: "Machine Row", muscleGroup: "Back", defaultSets: 3, defaultReps: "8-12", defaultRestSeconds: 120, source: "builtin" },
  ...
  { id: "lying-leg-curl", name: "Lying Leg Curl", muscleGroup: "Legs", defaultSets: 3, defaultReps: "10-15", defaultRestSeconds: 120, source: "builtin" },
  { id: "leg-extension", name: "Leg Extension", muscleGroup: "Legs", defaultSets: 3, defaultReps: "10-15", defaultRestSeconds: 120, source: "builtin" },
  ...
  { id: "reverse-cable-crossover", name: "Reverse Cable Crossover", muscleGroup: "Shoulders", defaultSets: 3, defaultReps: "12-20", defaultRestSeconds: 120, source: "builtin" },
  { id: "cable-lateral-raise", name: "Cable Lateral Raise", muscleGroup: "Shoulders", defaultSets: 3, defaultReps: "12-20", defaultRestSeconds: 120, source: "builtin" },
  { id: "face-pull", name: "Face Pull", muscleGroup: "Shoulders", defaultSets: 3, defaultReps: "12-20", defaultRestSeconds: 120, source: "builtin" },
  ...
  { id: "rope-triceps-pressdown", name: "Rope Triceps Pressdown", muscleGroup: "Arms", defaultSets: 3, defaultReps: "10-15", defaultRestSeconds: 120, source: "builtin" },
  { id: "overhead-cable-triceps-extension", name: "Overhead Cable Triceps Extension", muscleGroup: "Arms", defaultSets: 3, defaultReps: "10-15", defaultRestSeconds: 120, source: "builtin" },
  { id: "cable-curl", name: "Cable Curl", muscleGroup: "Arms", defaultSets: 3, defaultReps: "10-15", defaultRestSeconds: 90, source: "builtin" },
