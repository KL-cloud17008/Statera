...
const TRAINING_DAY_PRIMER: MobilityBlock = {
  ...
  exercises: [
    ...
    { name: "Tibialis raises", dose: "2 × 12-20", cues: "Slow controlled reps, pause at the top." },
    { name: "Standing calf stretch", dose: "30 sec/side", cues: "Keep heel down and breathe." },
    ...
    { name: "Dead bug or bird dog", dose: "6-8/side", cues: "Exhale fully and keep trunk stable." },
  ],
};
...
const REST_DAY_RECOVERY: MobilityBlock = {
  ...
  exercises: [
    ...
    { name: "Tibialis and calf work", dose: "6-8 min", cues: "Alternate tib raises with calf stretch/pump work." },
    { name: "Hip flexor mobility", dose: "2 × 30 sec/side", cues: "Stay tall and breathe through each hold." },
    ...
    { name: "Dead bug / bird dog", dose: "2 controlled rounds", cues: "Finish with stable trunk control." },
  ],
};
