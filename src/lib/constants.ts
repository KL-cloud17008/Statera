...
export const DEFAULT_REST_DAYS = [0, 6]; // Sat and Sun training dates = recovery/rest
...
export const TRAINING_DAY_LABELS: Record<number, string> = {
  ...
  2: "Tuesday • Upper A — Push/Pull Strength",
  3: "Wednesday • Posterior Chain + Upper Recovery Strength",
  4: "Thursday • Lower B — Low-Dose Legs + Hip Stability",
  5: "Friday • Training Reset — Machine Upper + Arms",
};
