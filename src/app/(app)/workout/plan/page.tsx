...
const WEEK_STRUCTURE = [
  ...
  {
    day: "Thursday",
    title: "Lower B — Single-Leg Strength + Hip Stability Circuit",
    protocol: "Strength Protocol",
    dayOfWeek: 4,
    note: "Progressive lower-body work without deep torso-compression leg pressing. Single-leg strength first, then controlled accessory circuit.",
    ...
    details: [
      ...
      "Block C: 3 controlled rounds. Seated Leg Curl, Hip Abduction Machine, Seated Leg Extension. Rest 2 minutes after C3.",
      "Thursday total working sets: 14.",
      "Overload target: add reps before load. Do not increase load on single-leg press unless range is pain-free and there is no thigh/torso compression. Bulgarian split squat progresses first by balance, control, and reps before adding dumbbells.",
    ],
  },
  {
    day: "Friday",
    ...
    protocol: "Strength Protocol",
    dayOfWeek: 5,
    note: "Higher-density full-body session with controlled circuits. Strength-density work, not HIIT. Rest until breathing is recovered.",
    ...
    details: [
      ...
      "Block B: Lat / Rear Delt / Back Extension circuit. Wide-Grip Lat Pulldown, Reverse Pec Deck, Back Hyperextension / Back Extension Machine. Rest 2 minutes after B3.",
      ...
      "Overload target: conservative loads, add reps before load, keep every rep clean. Do not add load to overhead press, skullcrushers, or back hyperextension unless movement is completely pain-free and technically stable.",
    ],
  },
  {
    day: "Saturday",
