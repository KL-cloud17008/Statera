        ...
        <Card key={plan.id}>
          ...
          <CardContent className="space-y-3">
            {plan.exercises.map((exercise) => (
              <div key={exercise.id} className={cn("rounded-[--radius-card] border border-border p-4 transition-colors", exercise.exerciseType === "WARMUP" ? "bg-muted/30" : exercise.exerciseType === "FINISHER" ? "bg-warning/8" : "bg-muted/15")}>
