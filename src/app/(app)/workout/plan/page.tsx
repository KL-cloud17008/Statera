...
const WEEK_STRUCTURE = [
  ...
  {
    day: "Thursday",
    title: "Lower B — Single-Leg Strength + Posterior Chain / Hip Stability",
    protocol: "Strength Protocol",
    dayOfWeek: 4,
    note: "Progressive lower-body work without deep torso-compression leg pressing. Single-leg strength first, posterior-chain practice second, then controlled accessory circuit.",
    laterRecovery: "Lower-Body Flush + Sole / Back Care, 10-14 minutes.",
    details: [
      "Stop leg press range before thigh/torso contact. If torso pressure appears, shorten range, reduce load, adjust seat/stance, or skip the leg press and complete Bulgarian split squats only.",
      "Block A: standalone range-limited single-leg press.",
      ...
      "Overload target: add reps before load. Do not increase load on single-leg press unless range is pain-free and there is no thigh/torso compression. Bulgarian split squat progresses first by balance, control, and reps before adding dumbbells. Back hyperextension does not progress by load yet; progress by cleaner reps and pain-free control only.",
    ],
  },
  {
    day: "Friday",
    title: "Full-Body Machine Circuit + Shoulders/Arms",
    protocol: "Strength Protocol",
    dayOfWeek: 5,
    note: "Higher-density upper/full-body machine session with controlled circuits. Back hyperextensions moved to Thursday. Strength-density work, not HIIT.",
    laterRecovery: "Weekly Downshift / Foot-Flare Recovery, 12-16 minutes.",
    details: [
      "Block A: Push/Pull pair. Incline Machine Press and Seated Cable Row. Rest 120 seconds after A2.",
      "Block B: Lat / Rear Delt pair. Wide-Grip Lat Pulldown and Reverse Pec Deck. Rest 120 seconds after B2.",
      "Block C: Quad / Hamstring pair. Leg Extension and Single-Leg Lying Curl. Rest 120 seconds after C2.",
      "Block D: Shoulders / Triceps / Biceps circuit. Seated Dumbbell Overhead Press, EZ-Bar Skullcrusher, EZ-Bar Biceps Curl. Rest 90-120 seconds after D3.",
      ...
      "Overload target: use conservative loads because density is high. Add reps before load. Keep all reps clean. Do not add load aggressively to overhead press or skullcrushers.",
    ],
  },
  {
    day: "Saturday",
